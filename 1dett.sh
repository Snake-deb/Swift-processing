...
function print {
echo -e "Date , Description , Taxable Value , Central Tax , State Tax , Integrated Tax "
for value in ${arr[@]}
do
...
if ! (($count % 4)); then echo -n "$date2 , $val$value"; fi
echo -ne " , $a"
let count+=1
...
echo ""
echo "$date2 ,tngsup , $tngsup0 , 0 , 0 , 0 "
echo "$date2 ,tnil , $tnil0 , 0 , 0 , 0 "
echo "$date2 ,texpt , $texpt0 , 0 , 0 , 0 "
echo "$date2 ,ztotal , $ttax , $tcamt , $tcamt , $tiamt"
echo ""
}
